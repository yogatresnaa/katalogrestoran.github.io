...
import { createLikeRestoButtonTemplate, createUnliekRestoButtonTemplate } from '../views/templates/template-creator';
...
const LikeButtonPresenter = {
  ...
  _renderLiked() {
    this._likeButtonContainer.innerHTML = createUnliekRestoButtonTemplate();
